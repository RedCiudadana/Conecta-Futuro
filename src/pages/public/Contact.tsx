...
const Contact: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl font-bold text-gray-900 mb-12 text-center">Contáctanos</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h3 className="mb-4 font-medium text-gray-700">Síguenos a través de nuestras redes sociales</h3>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <input
                ...
                className="mt-1 shadow-sm focus:ring-primary-500 focus:border-primary-500 block w-full sm:text-sm rounded-md"
            ...
            <div>
              <label htmlFor="affair" className="block text-sm font-medium text-gray-700">
