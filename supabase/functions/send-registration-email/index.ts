              ...
              <table cellpadding="0" cellspacing="0" style="margin:28px 0 0;">
                <tr>
                  <td style="background-color:#1a56db;border-radius:8px;">
                    <a href="https://escuela.redciudadana.org/course/${courseSlug}" style="display:inline-block;padding:12px 28px;color:#ffffff;font-size:14px;font-weight:600;text-decoration:none;">
                      Ver el curso
                    </a>
                  </td>
                </tr>
